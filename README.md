...
ai-resume-platform/
├── backend/
│   ├── src/main/java/com/resume/airesume/
│   │   ├── config/         # 配置类
│   │   ├── controller/     # 控制器层
│   │   ├── service/        # 服务层
│   │   │   └── impl/       # 服务实现
...
1. **全栈开发**：独立完成前后端开发，掌握完整开发流程
2. **AI应用**：接入大模型API，实现智能化功能
3. **文件处理**：实现PDF/Word文件解析
4. **安全认证**：使用JWT实现无状态认证，密码BCrypt加密
5. **生产部署**：完整部署到云服务器，真实线上环境
